...
public class ProgressibleBuilding : MonoBehaviour
{
    ...
    [SerializeField] private TweenAnimation<Transform> _showAnimation;
    [SerializeField] private TweenAnimation<Transform> _hideAnimation;
    ...
    private void HideBase(int index)
    {
        ...
        _hideAnimation.Animate(_baseModel.transform).OnComplete(()=> _baseModel.SetActive(false));
        _visibleBase = false;
    }
    ...
    private void ShowModel(int index)
    {
        ...
        _showAnimation.Prepare(_progressModels[index].transform);
        _showAnimation.Animate(_progressModels[index].transform);
    }
